...
from omnifold.data import msa_parsing
from omnifold.data.template_parsing import TEMPLATE_TYPE, QueryToTemplateAlignError
...
class Kalign:
    ...
    def align(self, sequences: Sequence[str], verbose: bool = False) -> str:
