"""Ligand constants used in OmniFold."""

import numpy as np
from beartype.typing import Final

from omnifold.common import amino_acid_constants, dna_constants

# This mapping is used when we need to store atom data in a format that requires
# fixed atom data size for every residue (e.g. a numpy array).
atom_types = [
    # NOTE: Adapted from: https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/c1fd92455be2a4133ad147242fc91cea35477282/rf2aa/chemical.py#L117C13-L126C18 (n.b., replaced Pr with Na)
    "AL",
    "AS",
    "AU",
    "B",
...
unk_restype_compact_atom_names_set = set(restype_name_to_compact_atom_names[unk_restype])
